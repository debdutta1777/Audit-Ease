        ...
        <AppLayout>
            <div className="max-w-6xl mx-auto space-y-12 pb-16">
                ...
                <div className="text-center space-y-4 animate-slide-up">
                    <span className="inline-block rounded-full border-2 border-blue-500/40 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 px-5 py-1.5 text-sm font-semibold text-blue-600 dark:text-blue-400 shadow-sm">
                        💎 Pricing
                    </span>
                    <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">
                        <span className="bg-gradient-to-r from-blue-600 via-cyan-600 to-blue-600 bg-clip-text text-transparent dark:from-cyan-400 dark:to-blue-400">
                            Simple, Transparent
                        </span>
                        {' '}Pricing
                    </h1>
                ...
                <div className="grid gap-8 lg:grid-cols-3">
                    {plans.map((plan, i) => (
                        <div
                            key={plan.id}
                            className={`animate-slide-up relative rounded-2xl border-2 p-8 transition-all duration-300 hover:scale-[1.02] ${plan.id === 'starter'
                                ? 'border-orange-200 dark:border-slate-700/50 bg-gradient-to-br from-orange-50 via-white to-rose-50 dark:from-slate-900/50 dark:to-slate-900/50 hover:shadow-xl hover:shadow-orange-200/50 dark:hover:border-slate-600 dark:hover:shadow-none'
                                : plan.popular
                                    ? 'border-purple-300 dark:border-cyan-500/50 bg-gradient-to-br from-purple-50 via-blue-50 to-cyan-50 dark:from-cyan-500/10 dark:to-blue-500/10 lg:scale-105 shadow-2xl shadow-purple-200/60 dark:shadow-[0_0_40px_rgba(34,211,238,0.15)]'
                                    : 'border-indigo-200 dark:border-slate-700/50 bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-slate-900/50 dark:to-slate-900/50 hover:shadow-xl hover:shadow-indigo-200/50 dark:hover:border-slate-600 dark:hover:shadow-none'
                                }`}
                            style={{ animationDelay: `${0.2 + i * 0.1}s` }}
                        >
                            {plan.popular && (
                                <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                                    <span className="rounded-full bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 px-5 py-2 text-sm font-bold text-white shadow-2xl shadow-purple-400/50 ring-2 ring-white dark:ring-transparent">
                                        ⭐ Most Popular
                                    </span>
                                </div>
                            )}
                            ...
                            <ul className="mb-8 space-y-3">
                                {plan.features.map((feature) => (
                                    <li key={feature} className="flex items-start gap-3 text-sm font-medium text-slate-700 dark:text-gray-300">
                                        <Check className="mt-0.5 h-5 w-5 flex-shrink-0 text-emerald-600 dark:text-cyan-400" />
                                        {feature}
                                    </li>
                                ))}
                            </ul>
                            ...
                            <Button
                                className={`w-full py-6 text-base font-bold transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] ${plan.id === 'starter'
                                    ...
                                    : plan.popular
                                        ? 'bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 text-white shadow-2xl hover:shadow-[0_10px_40px_rgba(147,51,234,0.5)] dark:hover:shadow-[0_0_40px_rgba(34,211,238,0.5)] border-0'
                ...
                <div className="mt-16 flex flex-wrap items-center justify-center gap-8 text-sm font-medium text-slate-600 dark:text-gray-400 animate-slide-up" style={{ animationDelay: '0.5s' }}>
                    {[
                        ...
                        <div key={badge.text} className="flex items-center gap-2 transition-colors hover:text-slate-900 dark:hover:text-gray-300">
                            <badge.icon className="h-5 w-5 text-blue-600 dark:text-cyan-400" />
                            {badge.text}
                        </div>
                    ))}
                </div>
