      ...
      <div className="relative z-10 min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-12 xl:px-20">
          <div className="max-w-md">
            <Link
              to="/"
              className="mb-8 inline-flex items-center gap-2 text-sm text-gray-400 transition-colors hover:text-cyan-400 group"
            >
            ...
            <div className="flex items-center gap-3 mb-6">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500 to-blue-500 shadow-[0_0_30px_rgba(34,211,238,0.4)]">
        ...
        <div className="flex w-full lg:w-1/2 items-center justify-center p-6 sm:p-8">
          <div className="w-full max-w-md">
            ...
            <Link
              to="/"
              className="lg:hidden mb-6 inline-flex items-center gap-2 text-sm text-gray-400 transition-colors hover:text-cyan-400"
            >
            ...
            <div className="lg:hidden text-center mb-8">
              <div className="flex justify-center mb-4">
                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500 to-blue-500 shadow-[0_0_30px_rgba(34,211,238,0.4)]">
            ...
            <div className="rounded-2xl border border-cyan-500/20 bg-slate-900/80 p-8 backdrop-blur-xl shadow-2xl">
              {/* Trial Badge */}
              {!isLogin && (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-11 h-12 bg-slate-800/50 border-slate-700 text-white placeholder:text-gray-500 focus:border-cyan-500 focus:ring-cyan-500/20 rounded-xl"
                      />
                    </div>
                  </div>
                )}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-11 pr-11 h-12 bg-slate-800/50 border-slate-700 text-white placeholder:text-gray-500 focus:border-cyan-500 focus:ring-cyan-500/20 rounded-xl"
                      required
                      minLength={6}
                    />
                    <button
                ...
                <Button
                  type="submit"
                  className="w-full h-12 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-semibold shadow-[0_0_20px_rgba(34,211,238,0.3)] hover:shadow-[0_0_30px_rgba(34,211,238,0.5)] transition-all rounded-xl text-base"
                  disabled={loading}
                >
                  {loading ? (
