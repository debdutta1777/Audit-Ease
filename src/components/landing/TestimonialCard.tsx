...
const TestimonialCard = ({ quote, author, role, company, rating, delay = "0s" }: TestimonialCardProps) => {
  return (
    <div 
      className="animate-slide-up group relative rounded-2xl border border-cyan-500/20 bg-slate-900/60 p-6 backdrop-blur-md transition-all duration-300 hover:border-cyan-400/40 hover:bg-slate-900/80"
