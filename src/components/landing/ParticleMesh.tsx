...
const ParticleMesh = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      gradient.addColorStop(0.3, "hsl(220, 40%, 10%)");
      gradient.addColorStop(0.7, "hsl(217, 32%, 12%)");
      gradient.addColorStop(1, "hsl(224, 35%, 9%)");
      ctx.fillStyle = gradient;
      ctx.fillRect(0, 0, canvas.width, canvas.height);

      // Add multiple radial glows for depth
      ...
      centerGlow.addColorStop(0, "hsla(198, 93%, 59%, 0.06)");
      centerGlow.addColorStop(0.5, "hsla(198, 93%, 59%, 0.02)");
      ...
      secondGlow.addColorStop(0, "hsla(220, 90%, 50%, 0.04)");
      secondGlow.addColorStop(0.5, "hsla(220, 90%, 50%, 0.01)");
      ...
      particles.forEach((particle, i) => {
        ...
        particleGlow.addColorStop(0, "hsla(198, 93%, 59%, 0.3)");
        particleGlow.addColorStop(0.5, "hsla(198, 93%, 59%, 0.1)");
        ...
        ctx.fillStyle = "hsla(198, 93%, 70%, 0.8)";
        ctx.fill();
        ...
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (distance < connectionDistance) {
            ...
            lineGradient.addColorStop(0, `hsla(198, 93%, 59%, ${opacity})`);
            lineGradient.addColorStop(0.5, `hsla(210, 90%, 55%, ${opacity * 0.8})`);
            lineGradient.addColorStop(1, `hsla(198, 93%, 59%, ${opacity})`);
      ...
      // Draw connection to mouse if close to particles
      particles.forEach((particle) => {
        ...
        if (distance < mouseInfluenceRadius * 0.8) {
          ...
          ctx.strokeStyle = `hsla(180, 90%, 60%, ${opacity})`;
          ctx.lineWidth = 0.5;
          ctx.stroke();
        }
      });
